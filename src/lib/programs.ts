  ...
  // point of the program.
  {
    ...
    phases: [
      ...
      },
      {
        ...
        schedule: [
          { label: 'Chest, Shoulders, Triceps, Abs', isRest: false, exercises: [
            { id: 'p16-e20', name: 'Low-Incline Dumbbell Press', sets: 2, reps: 8, restSeconds: 150, muscleGroup: 'chest', notes: 'Same tempo, heavier load than Phase 1 — the last 2 reps should be genuinely hard.' },
            { id: 'p16-e21', name: 'Pec Deck Machine', sets: 2, reps: 8, restSeconds: 90, muscleGroup: 'chest', notes: 'Full stretch at the back, squeeze hard at the front.' },
            { id: 'p16-e4', name: 'Seated Machine Shoulder Press', sets: 2, reps: 8, restSeconds: 150, muscleGroup: 'shoulders' },
            { id: 'p16-e22', name: 'EZ Bar Skull Crushers', sets: 2, reps: 8, restSeconds: 90, muscleGroup: 'arms', notes: 'Elbows stay stacked over the shoulders, lower to the forehead under control.' },
          ...
          { label: 'Legs (Quads, Hamstrings, Glutes, Calves)', isRest: false, exercises: [
            ...
            { id: 'p16-e25', name: 'Hack Squat', sets: 2, reps: 10, restSeconds: 150, muscleGroup: 'legs', notes: 'Back flat against the pad, control the descent — no bouncing.' },
          ...
          rest(),
          { label: 'Back, Biceps, Rear Delts, Abs', isRest: false, exercises: [
            { id: 'p16-e27', name: 'Pull-Ups (Assisted if needed)', sets: 2, reps: 8, restSeconds: 150, muscleGroup: 'back', notes: 'Full dead hang at the bottom, chin over the bar at the top.' },
            ...
            { id: 'p16-e30', name: 'EZ Bar Preacher Curls', sets: 2, reps: 8, restSeconds: 90, muscleGroup: 'arms', notes: 'No swinging — the preacher pad enforces strict form, use it.' },
            { id: 'p16-e31', name: 'Concentration Curls', sets: 2, reps: 8, restSeconds: 90, muscleGroup: 'arms', notes: 'Slow and deliberate — this is a mind-muscle-connection exercise.' },
            { id: 'p16-e10', name: 'Abs — Exercise of Choice', sets: 3, reps: 15, restSeconds: 45, muscleGroup: 'core' },
          ] },
          rest(),
          rest(),

...
export const DEFAULT_B2B_LANDING_CONFIG: B2BLandingConfig = {
  ...
  pricingTiers: [
    {
      name: 'Full White-Label Setup',
      price: '2,997',
      period: 'one-time',
      description: 'Everything you need to launch your own branded training app — installed, branded, and ready to sell.',
      features: [
        'Installed on your own VPS & domain',
        'Full white-label branding — logo, colors, app name',
        'AI program + nutrition matching for every new client',
        'Custom program library built to your business',
        'Community channels, PR wall & direct messaging pre-configured',
        'Streaks, XP, achievements & leaderboard — retention built in',
        'Your own admin dashboard to run everything',
        '30 days of setup support included',
        'You own it — no monthly fee, ever',
      ],
      highlighted: true,
    },
  ],

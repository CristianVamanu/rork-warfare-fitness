...
app.get("/api/health", async (c) => {
  ...
  const fbServerDiag = {
    ...
    EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET:     process.env.EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET     ? '✓ set' : '✗ MISSING (optional)',
    EXPO_PUBLIC_FIREBASE_MESSAGING_SENDER_ID: process.env.EXPO_PUBLIC_FIREBASE_MESSAGING_SENDER_ID ? '✓ set' : '✗ MISSING (optional)',
